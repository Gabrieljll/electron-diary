...
async function editarFichaCliente(idFicha){      
    ...
    var fichaFechaModal = String(new Date(fichaDevuelta[0].fecha).getFullYear() + '-' + String(new Date(fichaDevuelta[0].fecha).getMonth() + 1).padStart(2, '0') + '-' + String(new Date(fichaDevuelta[0].fecha).getDate()).padStart(2, '0'))
    
    Swal.fire({
        html:`
        <h1 class="tituloModal">Editar Ficha</h1>
        <hr>
        <div id="modal_${fichaDevuelta[0].id}" class="modalEditar" class="col-md-12 p-4 my-auto">
        <div action="" id="formulario_producto_edit">        
            ...
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Código de cliente</strong></h5></label>
                <input type="text" id="numeroPedido_edit" placeholder="Número de pedido" class="form-control" value="${fichaDevuelta[0].numeroPedido}" autofocus required="true">
            </div>
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Cliente</strong></h5></label>
                <input type="text" id="nombreCliente_edit" placeholder="Nombre de Cliente" class="form-control" value="${fichaDevuelta[0].nombreCliente}" autofocus required="true">
            </div>
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Celular</strong></h5></label>
                <input type="number" id="numeroContacto_edit" placeholder="Número de Contacto" class="form-control" value="${fichaDevuelta[0].numeroContacto}" autofocus required="true">
            </div>
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Producto</strong></h5></label>
                <input type="text" id="producto_edit" placeholder="Nombre del producto a entregar" class="form-control" value="${fichaDevuelta[0].producto}" autofocus required="true">
            </div>
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Precio del producto</strong></h5></label>
                <input type="number" id="precioProducto_edit" placeholder="Precio del producto" class="form-control" step="0.01" value="${fichaDevuelta[0].precioProducto}" autofocus required="true">
            </div>   
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Dirección de la entrega</strong></h5></label>
                <input type="text" id="direccion_edit" placeholder="Dirección o ubicación" class="form-control" value="${fichaDevuelta[0].direccion}" autofocus required="true">
            </div>
            <div class="form-group">
                <label class="mt-2" for=""><h5><strong>Observaciones</strong></h5></label>
                <textarea id="observaciones_edit" rows="3" placeholder="observaciones" class="form-control" value="${fichaDevuelta[0].observaciones}"></textarea>
            </div>
            <button onclick="fichaClienteEditada(${fichaDevuelta[0].id})" class="btn btn-success mt-1">
                EDITAR
            </button>
        </div>                
    </div>
